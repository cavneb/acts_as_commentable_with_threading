Gem::Specification.new do |s|
  s.name     = "acts_as_commentable_with_threading_rails_4"
  s.version  = "1.1.2"
  s.date     = "2012-03-23"
  s.summary  = "Polymorphic comments Rails gem - Rails 4"
  s.email    = "evan@tripledogdare.net"
  s.homepage = "http://github.com/cavneb/acts_as_commentable_with_threading"
